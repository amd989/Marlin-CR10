...
#define STRING_CONFIG_H_AUTHOR "(Alejandro Mora)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "ACRO Laser"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 57.143, 57.143, 57.143 }
